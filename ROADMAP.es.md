...
- vistas de inteligencia de red de más alto nivel inspiradas en patrones tipo proxy/analytics de ntopng, por ejemplo `ntop-network-stats`, `ntop-security-summary`, `ntop-host-profile` y `ntop-traffic-summary`
